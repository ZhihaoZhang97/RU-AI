...
# List of flickr filenames only
SPECIFIC_FILES = [
    "text_flickr8k.tar.xz",
    "image_flickr8k.tar.xz",
    "audio_flickr8k.tar.xz",
]
...
print("Flickr8k files downloaded and extracted to correct directories successfully.")
